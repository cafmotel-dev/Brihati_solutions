                ...
                <li class="menu-item menu-item-has-children-mobile">
                  ...
                  <ul class="sub-menu-mobile">
                    ...
                    <li class="menu-item menu-item-mobile">
                      ...
                      <li class="menu-item menu-item-mobile">
                        <a href="blog-detail-side-bar.html">Blog Detail Sidebar</a>
                      </li>
                  </ul>
                </li>
                <li class="menu-item menu-item-has-children-mobile">
                  ...
                  <ul id="menu-primary-menu" class="menu">
                    ...
                    <li class="menu-item menu-item-has-children">
                      ...
                      <ul class="sub-menu st1">
                        <li class="nav-sub">
                          <a href="find-jobs-list.html">Jobs Listing <span class="icon-keyboard_arrow_right"></span>  </a>
                    ...
                    <li class="menu-item menu-item-has-children">
                      ...
                      <ul class="sub-menu st1">
                        <li class="nav-sub">
                          <a href="employers-list.html">Employers Listing <span class="icon-keyboard_arrow_right"></span>  </a>
                          <ul class="nav-sub-menu">
                    ...
                    <li class="menu-item menu-item-has-children">
                      ...
                      <ul class="sub-menu st1">
                        <li class="nav-sub">
                          <a href="candidate.html">Candidates Listing <span class="icon-keyboard_arrow_right"></span>  </a>
                          <ul class="nav-sub-menu">
              ...
              <div class="header-customize-item account">
                ...
                <div class="sub-account">
                  <div class="sub-account-item">
                    <a href="dashboard/candidates-dashboard.html"><span class="icon-dashboard"></span>Dashboard</a>
                  </div>
                  <div class="sub-account-item">
                  ...
                  <div class="sub-account-item">
                    <a href="dashboard/candidates-alerts-jobs.html"><span class="icon-bell1"></span> Candidate
                      Alerts</a>
                  </div>
                  <div class="sub-account-item">
                  ...
                  <div class="sub-account-item">
                    <a href="dashboard/candidates-following-employers.html"><span class="icon-following"></span>
                      Following Employers</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="dashboard/candidates-meetings.html"><span class="icon-meeting"></span> Meeting</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="dashboard/candidates-change-passwords.html"><span class="icon-change-passwords"></span>
                      Change
                      Passwords</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="dashboard/candidates-delete-profile.html"><span class="icon-trash"></span> Delete
                      Profile</a>
                  </div>
                  <div class="sub-account-item">
